...
#
# == Modifications
# Modified by Xzanth to fit with my other plugins I use and structure as a ruby
# gem. Small changes to fit stylistically and change where the class resides.
#
# == License
